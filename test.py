...
# predict the future
    ...
    # # # Pad the list with zeros to match the desired shape (301, 1)
    # # padding_length = 301 - len(y_valid)
    # # my_list_padded = y_valid + [0] * padding_length
    
    # # # Convert the padded list to a NumPy array
    # # my_array = np.array(my_list_padded)
    
    # # # Reshape the array to (301, 1)
    # # my_array_reshaped = my_array.reshape((301, 1))    
    
    # # print("-----------------------------------------")
    # # print(my_array_reshaped)
    # # print("-----------------------------------------")
    # # print(future_closing_price)
    # # print("-----------------------------------------")
    
    # # a=np.squeeze(my_array_reshaped)
    # # b=np.squeeze(future_closing_price)
...
def fgraph():
    ...
    # return render_template('line_chart2.html',stockname=company,user_image=dst1,
    #                         values1=ttf4,labels1=dt4, 
    #                         values2=BDLSTMttf, labels2=BDLSTMdt,
    #                         values3=BDGRUttf, labels3=BDGRUdt, 
    #                         values4=GRUttf, labels4=GRUdt, 
    #                         values5=CLSTMtf, labels5=CLSTMdt, 
    #                         values6=CGRUtf, labels6=CGRUdt,
    #                         symbolis=op1)
